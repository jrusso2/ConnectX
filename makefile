...
test: cpsc2150/extendedConnectX/tests/TestGameBoard.java cpsc2150/extendedConnectX/tests/TestGameBoardMem.java cpsc2150/extendedConnectX/models/AbsGameBoard.java cpsc2150/BoardPosition/models/AbsGameBoard.java cpsc2150/extendedConnectX/models/GameBoard.java cpsc2150/extendedConnectX/models/GameBoardMem.java cpsc2150/extendedConnectX/models/IGameBoard.java
...
testGB: cpsc2150/extendedConnects/TestGameBoard.class cpsc2150/extendedConnectX/models/AbsGameBoard.class cpsc2150/BoardPosition/models/AbsGameBoard.class cpsc2150/extendedConnectX/models/GameBoard.class cpsc2150/extendedConnectX/models/GameBoardMem.class cpsc2150/extendedConnectX/models/IGameBoard.class
    java -cp .:/usr/share/java/junit4.jar org.junit.runner.JUnitCore cpsc2150.extendedConnectX.tests.TestGameBoard

testGBmem: cpsc2150/extendedConnects/TestGameBoardMem.class cpsc2150/extendedConnectX/models/AbsGameBoard.class cpsc2150/BoardPosition/models/AbsGameBoard.class cpsc2150/extendedConnectX/models/GameBoard.class cpsc2150/extendedConnectX/models/GameBoardMem.class cpsc2150/extendedConnectX/models/IGameBoard.class
