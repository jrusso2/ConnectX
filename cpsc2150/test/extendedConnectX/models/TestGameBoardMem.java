...
public void testGameBoardConstructorStandardVals() {
    ...
    int cols = 7;
    int win = 4;
    IGameBoard gameBoard = gameBoardMemFactory(rows, cols, win);
    ...
    public void testGameBoardConstructorMinVals() {
        ...
        int minCols = 3;
        int minWin = 3;
        IGameBoard gameBoard = gameBoardMemFactory(minRows, minCols, minWin);
    ...
    public void testGameBoardConstructorMaxVals() {
        ...
        int maxCols = 100;
        int maxWin = 25;
        IGameBoard gameBoard = gameBoardMemFactory(maxRows, maxCols, maxWin);
